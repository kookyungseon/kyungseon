        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <p className="text-[#2D3748] text-xl leading-relaxed mb-8">
              "주어진 환경에 사고를 가두지 않는다"는 철학으로 문제를 해결합니다. 
              팀원들이 포기하려 할 때 ngrok을 도입해 서비스 체험 환경을 구축했고, 
              메시지 API 토큰 만료 문제를 발견해 자동 갱신 로직을 구현했습니다. 
              클라우드 아키텍처에서도 퍼블릭 서브넷의 보안 취약점을 발견하고 
              3-Tier 아키텍처로 전면 재설계한 경험이 있습니다. 
              작은 오류 하나가 고객 불편으로 이어질 수 있다는 책임감으로 
              모든 케이스를 철저히 검증하는 개발자입니다.
            </p>
          </div>
