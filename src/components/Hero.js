      ...
      <div className="max-w-6xl mx-auto px-6 w-full relative z-10">
        <div className="text-center">
          ...
          <p className="text-[#2D3748] text-lg mb-8 max-w-3xl mx-auto leading-relaxed">
            지구환경과학과와 소프트웨어학과 복수전공으로 데이터 분석과 시스템 설계의 두 마리 토끼를 잡았습니다. 
            창의적 사고로 ngrok을 활용해 로컬 환경의 한계를 극복하고 최우수상을 수상했으며, 
            멀티모달 AI 시스템에서 비동기 큐와 풀백 로직을 설계해 안정성을 확보했습니다. 
            기술의 완성도가 곧 서비스의 신뢰와 직결된다는 믿음으로, 
            단순한 기능 구현을 넘어 사용자 경험까지 고려하는 개발자입니다.
          </p>
